import { createAuthorizationRequest, exchangeCodeForTokens, API_USER_AGENT, } from "./oauth.js";
const plugin = async () => {
    return {
        auth: {
            provider: "anthropic",
            methods: [
                {
                    ...
                    authorize() {
                        ...
                        return Promise.resolve({
                            url,
                            instructions: "Open the link above to authenticate with your Claude account. " +
                            ...
                            async callback(code) {
                                try {
                                    ...
                                    console.error("opencode-anthropic-oauth: token exchange failed:", err instanceof Error ? err.message : err);
                                    return { type: "failed" };
                                }
                            },
                        });
